...
// CODE HERE
let postTax = prices.map((element) => element * 1.07)
console.log(postTax)
...
// CODE HERE
// const sumPop = populations.reduce((people, folks) => people + folks)
// console.log(sumPop)
...
// CODE HERE
let newOrder = orders.map((afterTax) => afterTax.price + (afterTax.price * afterTax.tax)) 
...
// CODE HERE
let newTotal = purchases.filter((bob) => bob.owner === "Bob").reduce((price, total) => price + total.price, 0)
